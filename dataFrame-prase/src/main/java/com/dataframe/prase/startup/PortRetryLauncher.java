package com.dataframe.prase.startup;
...
@Slf4j
public final class PortRetryLauncher {
    ...
    PortRetryLauncher(ApplicationStarter starter) {
        this(starter, uri -> {
        });
    }

    PortRetryLauncher(ApplicationStarter starter, BrowserLauncher browserLauncher) {
        this.starter = starter;
        this.browserLauncher = browserLauncher;
    }

    public static PortRetryLauncher forSpringApplication(Class<?> primarySource) {
        return new PortRetryLauncher(
                (port, address) -> {
                ...
                PortRetryLauncher::openHomePageInDefaultBrowser);
    }
