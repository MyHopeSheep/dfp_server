...
public class CsvParseController {
    ...
    private final CsvParseWebService csvParseWebService;


    public CsvParseController(CsvParseWebService csvParseWebService) {
    ...
    public ResponseEntity<byte[]> parse(
        ...
        ParseDownload download = csvParseWebService.parse(file, configKey);
